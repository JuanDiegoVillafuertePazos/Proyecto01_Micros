...
isr:
    ...
    btfsc ((INTCON) and 07Fh), 2 ;chequear la bandera de interrupcion del tmr0
    call int_tmr0 ;llama a la subrutina del tmr0

    btfsc ((PIR1) and 07Fh), 0 ;chequear la bandera de interrupcion del tmr1
    call int_tmr1
...
config_iocb:
    ...
    banksel PORTA
    movf PORTB, w
    bcf ((INTCON) and 07Fh), 0 ;borrar bandera
    return
...
rst_tmr0:
    movlw 125
    movwf TMR0
    bcf ((INTCON) and 07Fh), 2 ;borrar bandera del tmr0
    return
...
config_inten:
    ...
    bsf ((INTCON) and 07Fh), 3 ;interrupt por cambion habilitado
    bcf ((INTCON) and 07Fh), 0
